<?php
$logoLucmar = 'public/assets/img/logolucmar.jpg';
$loginForm = 'src/components/loginForm/loginForm.php';
    ...
    <div class="flex flex-col items-center justify-start h-full w-96 px-8">
        <div class="w-full px-5 flex flex-row items-center justify-evenly gap-0 mb-10">
            <div class="h-auto w-[70px]">
                <img class="w-full rounded-xl" src='<?php echo $logoLucmar; ?>' alt="" />
            </div>
        ...
        <div class="w-full">
            <h1 class="font-sans font-bold text-4xl tracking-wide text-slate-800 text-center">Iniciar sesión</h1>
            <?php
            include ($loginForm);
            ?>
        </div>
