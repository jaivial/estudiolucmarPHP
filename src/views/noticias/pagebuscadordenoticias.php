...
<body class="overflow-x-hidden bg-slate-200">
    ...
    <main class="h-auto w-[100%] flex flex-row justify-start items-stretch bg-slate-200">
        ...
        <div id="buscadordenoticias" class=" lg:ml-52 w-[100%] h-auto bg-slate-200 overflow-y-auto">
            <?php
            include 'buscadordenoticias.php';
            ?>
        </div>
    </main>

    <script>
            const mobileItemBuscador = document.getElementById("mobile-itemBuscador");
